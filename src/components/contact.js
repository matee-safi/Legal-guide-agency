      ...
      <div className="contact-section p-5 py-10 text-center">
        ...
        <div className="md:hidden">
          ...
          <div className="flex justify-center gap-5">
            <a href="https://www.facebook.com/legalguide.edu" target="_blank" rel="noreferrer"><StaticImage width={30} src="../../static/facebook.png" alt="facebook icon" /></a>
            <a href="mailto:legalguide.edu@gmail.com" target="_blank" rel="noreferrer"><StaticImage width={30} src="../../static/email.png" alt="gmail icon" /></a>
            <a href="https://api.whatsapp.com/send?phone=0202200820" target="_blank" rel="noreferrer"><StaticImage width={30} src="../../static/whatsapp.png" alt="whatsapp icon" /></a>
          </div>
        </div>
      </div>
    </section>
