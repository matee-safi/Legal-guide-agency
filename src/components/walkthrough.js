    ...
    <section id="walkthrough">
      <div className="walkthrough-container text-center">
        ...
        <div className="video-container flex justify-center p-5">
          <iframe className="video" src="https://www.youtube.com/embed/OWa28ZQqOc8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
        </div>
      </div>
    </section>
   );
